...
router
    .route("/")
    .get(allowedTo(ROLES.ADMIN, ROLES.COACH), getAllValidate, getAll)
    .post(allowedTo(ROLES.ADMIN), createValidate, create);

// لازم قبل /:id
router.get("/summary", allowedTo(ROLES.ADMIN, ROLES.COACH), summaryValidate, getSummary);
router.get("/monthly", allowedTo(ROLES.ADMIN), monthlyPanelValidate, getMonthlyPanel);
...
router
    .route("/:id")
    .get(allowedTo(ROLES.ADMIN, ROLES.COACH), getSpecificValidate, getSpecific)
