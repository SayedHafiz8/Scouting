 ...
 * على الفرق.
 *
 * الأوبزيرفر مش هنا — فرعه لسه في seasonMatchBaseFilterFor مباشرة، لأنه مش
 * مجرد قيمة ثابتة زي فرع proScout هنا: بيتحدد بفحص "عنده لاعب متعيَّن ولا لأ"
 * (Player.exists)، مش بشرط ثابت على المستند نفسه زي league. كان فيه فرع بيقصره
 * على مباريات فرق لاعبينه المتابَعين فقط، اتلغى بالكامل عمداً — مش نُقل — عشان
 * الأوبزيرفر المعيَّن له لاعب واحد على الأقل يقدر يختار ويحضر أي مباراة من
 * الدورين، مش يتقيد بفرق اللاعبين المعيَّن ليهم تحديداً. شرط "عنده لاعب أصلاً"
 * فضل قائم عمداً — أوبزيرفر لسه بلا أي لاعب معيَّن يشوف صفر، زي الأول بالظبط.
 * الدالة دي بترجع {} لأي رول غير proScout، والكنترولر هو اللي بيركّب الفرعين.
 */
